...
set foldenable
set fdl=3
set formatoptions+=mM   " 设置textwidth时，对中文（multi-byte character）也能自动换行
...
set mouse=c      " 在所有模式下都允许使用鼠标，还可以是n,v,i,c等
...
nmap <silent> <F10> <ESC>:TlistUpdate<RETURN>
